#ifndef _PINNINGPROCESSPARAMS_HPP_
#define _PINNINGPROCESSPARAMS_HPP_
...
template<typename F>
class NormalPinningParams : public CoordonatesSystemParams<F>
{
public:
...
template<typename F>
class NormalLensUndistortParams : public NormalPinningParams<F>
{
public:
...
template<typename F>
class FisheyePinningParams : public NormalLensUndistortParams<F>
{
public:
	F _coef2;

public:
	virtual ~FisheyePinningParams() {}
};

template<typename F>
class FisheyeLensUndistortParams : public FisheyePinningParams<F>
{
public:
...
template<typename F>
class AdvancedPinningParams : public FisheyeLensUndistortParams<F>
{
public:
	typedef typename CoordonatesSystemParams<F>::Point2 Point2;
...
public:
	virtual ~AdvancedPinningParams() {}
};

template<typename F>
class AdvancedLensUndistortParams : public AdvancedPinningParams<F>
{
public:
...
template<typename F>
class PinningProcessParams : public AdvancedLensUndistortParams<F>
{
public:
	virtual ~PinningProcessParams() {}
};
